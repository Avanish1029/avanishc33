...
function setup(){
    ...
    birds.push(bird2);
    birds.push(bird);
    //log6 = new Log(230,180,80,    bird = new Bird(200,50);PI/2);
...
function draw(){
    if(backgroundImg){
        ...
        if(birds.length>0){
            text("press spacekey for next bird",width/2-200,25);
            text("bird"+birds.length,width/2-100,60);
        }
        else {
            text("click reload button to reload the game ",width/2-200,70);
